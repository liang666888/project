package pers.wl.album.config.aspect;
...
import pers.wl.album.controller.base.request.BaseRestRequest;
...
public class WebLogAspect {
	...
	@Pointcut("execution(public * pers.wl.album.controller..*Controller.*(..))")
	private void weblog() {
	}
